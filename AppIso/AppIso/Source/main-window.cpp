...
void MainWindow::UpdateGeometry(bool entire) {
    if (entire) {
...
void MainWindow::CreateActions()
{
	...
	connect(m_uiw.generate_figures_button, &QPushButton::clicked, this, &MainWindow::GenerateFigures);
	...
	connect(this, &MainWindow::isoChanged, [this](IsoLines* isos) {
	...
	// G�n�ration
	connect(m_uiw.generation_box_y_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetGenBox);
	connect(m_uiw.generation_box_h_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetGenBox);
	connect(m_uiw.generation_box_w_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetGenBox);
	connect(m_uiw.generation_box_x_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetGenBox);
	...
	connect(m_uiw.poisson_radius_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetPoissonRadius);

	connect(m_uiw.histogram_button, &QPushButton::clicked, this, &MainWindow::BrowseHistogram);
	connect(m_uiw.histogram_function_selector, QOverload<int>::of(&QComboBox::activated), this, [this](int) { ChangeHistogramFromUI(); });
	connect(m_uiw.noise_button, &QPushButton::clicked, this, &MainWindow::BrowseNoise);
	connect(m_uiw.mask_button, &QPushButton::clicked, this, &MainWindow::BrowseMask);
	connect(m_uiw.mask_from_view_isos_button, &QPushButton::clicked, this, &MainWindow::ChangeMaskFromCurrentIsos);
	...
	// �dition
	connect(m_uiw.view_box_y_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetViewBox);
	connect(m_uiw.view_box_h_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetViewBox);
	connect(m_uiw.view_box_w_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetViewBox);
	connect(m_uiw.view_box_x_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetViewBox);

	connect(m_uiw.heights_max_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetHeights);
	connect(m_uiw.heights_min_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetHeights);

	connect(m_uiw.terrain_x_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetTerrainSize);
	connect(m_uiw.terrain_y_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetTerrainSize);

	connect(m_uiw.camera_longitude_angle_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	connect(m_uiw.camera_latitude_angle_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	connect(m_uiw.camera_dist_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	connect(m_uiw.camera_lookat_x_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	connect(m_uiw.camera_lookat_y_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	connect(m_uiw.camera_lookat_z_edit, &QLineEdit::editingFinished, this, &MainWindow::ResetCamera);
	...
	connect(m_uiw.edition_tool_selector, &QComboBox::currentIndexChanged, this, &MainWindow::ChangeEditionTool);

	connect(m_uiw.edition_radius_edit, &QLineEdit::textChanged, this, &MainWindow::ResetEditionOptions);
	connect(m_uiw.point_min_dist_edit, &QLineEdit::textChanged, this, &MainWindow::ResetEditionOptions);
	...
	connect(m_uiw.edition_delta_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetSmoothingOptions);
	connect(m_uiw.edition_dist_edit, &QLineEdit::textChanged, this, &MainWindow::ResetSmoothingOptions);

	connect(m_uiw.warp_strength_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetWarpingOptions);
	connect(m_uiw.warp_factor_eps_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetWarpingOptions);
	connect(m_uiw.warp_pow_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetWarpingOptions);

	connect(m_uiw.slope_pow_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetSlopingOptions);
	connect(m_uiw.slope_strength_edit, &QDoubleSpinBox::textChanged, this, &MainWindow::ResetSlopingOptions);

	connect(m_uiw.toggle_remove_circles, &QCheckBox::toggled, this, &MainWindow::ResetProtectingOptions);
	connect(m_uiw.toggle_show_zones, &QCheckBox::toggled, this, &MainWindow::ResetProtectingOptions);
	connect(m_uiw.protect_small_isolines_edit, &QLineEdit::textChanged, this, &MainWindow::ResetProtectingOptions);
	connect(m_uiw.clean_protected_zones_button, &QPushButton::clicked, this, &MainWindow::CleanProtectedZones);
	...
	connect(m_uiw.clean_view_button, &QPushButton::clicked, this, &MainWindow::CleanIsos);
	connect(m_uiw.reset_zoom_button, &QPushButton::clicked, this, &MainWindow::ResetViewBox);
	connect(m_uiw.reset_from_mask_button, &QPushButton::clicked, this, &MainWindow::SetIsosFromMask);

	connect(m_uiw.iso_view, &IsoView::pathFinished, this, &MainWindow::ViewPathFinished);
	connect(m_uiw.iso_view, &IsoView::rightClickOn, this, &MainWindow::ViewRightClick);
