 ...
 * 
 * \param debug Si != 0, nombre de debug � faire (un tous les `debug` frames)
...
void IsoVectoGenerationV2::CreateBorders()
{
	...
	for (int nodeId = 0; nodeId < Z.Size(); ++nodeId)
	{
		...
		// La bordure consiste en les �l�ments de la zone plus basse qui sont au bord d'un �l�ment de la zone actuelle
		// Lorsque c'est la premi�re zone, la bordure est constitu� des gens d�j� d�fini (d'o� le <= et pas <)
...
bool IsoVectoGenerationV2::ChooseNextNode()
{
	...
	while (true)
	{
		// On r�cup�re un �l�ment de bordure
...
// Renvoie un noeud al�atoire, en fonction des bordures donn�es.
