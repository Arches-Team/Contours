...
{
	// Sans �a, impossible de suivre le curseur si aucun bouton n'est appuy�.
...
void IsoView::ResetView()
{
    ...
    scale(1, -1); // Pour que l'image soit � l'endroit, car Qt met les y vers le bas et pas vers le haut comme nous
}
